...

{
  ...
  mrates <- function(x, params, t) {
    ...
    return(c(
      ...
      S * (0.01 + ifelse(((1-((S+RA+RB+RAB)/(10^Bmax*V)))*(Gmax+0.01)) > 0, 
      ...
      RA * (0.01 + ifelse(((1-((S+RA+RB+RAB)/(10^Bmax*V)))*(Gmax+0.01)*FIT) > 0, 
      ...
      RB * (0.01 + ifelse(((1-((S+RA+RB+RAB)/(10^Bmax*V)))*(Gmax+0.01)*FIT) > 0, 
