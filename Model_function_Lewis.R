                            ...
                            for(i_mod in 1:length(PK_model_list)) {
                              ...
                              while (t < ST*DT) {
                                ...
                                if(tau_PD < 1){
                                  ...
                                  # Initialize lambda_i
                                  lambda_i <- c(                         
                                    S_i * (gS +d0 + 0.01) * rS_RA * (1-rS_RB),           # S to RA mutation
                                    S_i * (gS +d0 + 0.01) * rS_RB * (1-rS_RA),           # S to RB mutation  
                                    S_i * (gS+d0 + 0.01) * rS_RB * rS_RA,                # S to RAB mutation
                                    RA_i * (gRA +d0+ 0.01) * rRA_RAB,                    # RA to RAB mutation                                                   
                                    RB_i * (gRB +d0+ 0.01) * rRB_RAB,                    # RB to RAB mutation                                                    
